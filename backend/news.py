...
def get_news(q, offset):
    ...
    my_model = pipeline('summarization' , 'current_model')
    results = []
    ...
    for link in res:
        try:
            ...
            link["summary"] = my_model(a.text , max_length=130, min_length=30, do_sample=False)[0]['summary_text']
